...
interface GalleryControlsFullProps {
  activeIndex: number;
...
export function GalleryControlsFull({
  activeIndex,
  setActiveIndex,
}: GalleryControlsFullProps) {
    ...
    <div className="flex justify-between items-center mt-10 relative">
      ...
      <div className="absolute left-1/2 top-1 transform -translate-x-1/2 flex gap-16">
        <button
          ...
          className="disabled:opacity-50 transition-opacity duration-200 text-white bg-[#343434] hover:not-disabled:text-[#999] cursor-pointer"
        >
